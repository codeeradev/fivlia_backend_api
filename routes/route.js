...
router.get("/getProducts", verifyToken, typeCategoryResolver, getProduct);
...
router.get("/website/bestSelling", typeCategoryResolver, forwebbestselling);
router.get("/website/getProduct", forwebgetProduct);
router.get("/website/featureProduct", typeCategoryResolver, forwebgetFeatureProduct);
router.get("/website/searchProduct", typeCategoryResolver, forwebsearchProduct);
router.get("/website/relatedProducts", typeCategoryResolver, forwebgetRelatedProducts);
...
router.get("/bestSelling", verifyToken, typeCategoryResolver, bestSelling);
router.get("/search", verifyToken, typeCategoryResolver, searchProduct);
